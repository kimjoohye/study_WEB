...
<body>   
    ...
    <table border="1">
        <tr>
            ...
            <td width="100"><input type="text" name="user" id="user" size="20"/><br/></td>
        </tr>
        <tr>
            <td><label for="title">제목</label></td>
            <td><input type="text" name="title" id="title" size="20"/><br/></td>
        </tr>
        <tr>
            <td><label for="uploadFile">파일</label></td>
            <td><input type="file" name="uploadFile" id="uploadFile"/><br/></td>
        </tr>
        <tr>
            <td><label for="uploadFile2">파일2</label></td>
            <td><input type="file" name="uploadFile2" id="uploadFile2"/><br/></td>
        </tr>
        <tr>
